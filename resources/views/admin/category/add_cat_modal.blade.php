        ...
        <div class="modal-header">
            ...
            <form id="addcategoryForm" name="addcategoryForm" method="POST" class="form-horizontal" enctype="multipart/form-data">@csrf
                ...
                <div class="form-group">
                    <label for="category_description" id="category_descriptionLabel" class="col-sm-auto control-label">Description</label>
                    <div class="col-sm-12">
                        <textarea class="form-control" rows="2" id="category_description" name="category_description" 
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-12">
                            <textarea rows="2" class="form-control" id="category_meta_description" name="category_meta_description" 
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-12">
                            <textarea rows="2" class="form-control" id="category_meta_keywords" name="category_meta_keywords" 
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <div class="h-100 d-flex align-items-center justify-content-center">
                            <img class="border" width="150" height="150" id="category_imageView" name="category_imageView"/>
                        </div>
                    </div>
