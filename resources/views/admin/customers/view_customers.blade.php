...
<div class="card container-fluid justify-content-centers">
    ...
    <a style="width: 150px;margin-right: 15px;" class="btn btn-success ml-auto mb-2" data-toggle="modal"
        data-target="#addCustomersModal" id="createNewCustomers">Add Customers</a>
    <!-- /.card-header -->
    <div class="card p-0 table-data">
        <div class="card-body">
            <table id="CustomersViewTable" class="table table-bordered table-striped CustomersViewTable">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Name</th>
